...
#[rustfmt::skip]
#[cfg(feature = "nota-text")]
impl nota_next::NotaBodyDecode for InterfaceProjection {
    fn from_nota_body(
        ...
        match variant {
            "FullProjection" => {
                Ok(
                    Self::FullProjection(
                        <InterfaceState as nota_next::NotaDecode>::from_nota_block(
                            &children[1],
                        )?,
                    ),
                )
            ...
            "StatusProjection" => {
                Ok(
                    Self::StatusProjection(
                        <StatusText as nota_next::NotaDecode>::from_nota_block(
                            &children[1],
                        )?,
                    ),
                )
            ...
            "NotificationProjection" => {
                Ok(
                    Self::NotificationProjection(
                        Some(
                            <NotificationText as nota_next::NotaDecode>::from_nota_block(
                                &children[1],
                            )?,
                        ),
                    ),
            ...
            "PendingQuestionsProjection" => {
                Ok(
                    Self::PendingQuestionsProjection(
                        <PendingQuestionsView as nota_next::NotaDecode>::from_nota_block(
                            &children[1],
                        )?,
                    ),
                )
...
#[rustfmt::skip]
#[cfg(feature = "nota-text")]
impl nota_next::NotaDecode for InterfaceProjection {
    fn from_nota_block(
...
#[rustfmt::skip]
#[cfg(feature = "nota-text")]
impl nota_next::NotaEncode for InterfaceProjection {
...
#[rustfmt::skip]
impl std::fmt::Display for QuestionIdentifier {
    fn fmt(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        self.payload().fmt(formatter)
    }
}
#[rustfmt::skip]
impl AsRef<str> for QuestionIdentifier {
    fn as_ref(&self) -> &str {
        self.payload().as_str()
    }
}
#[rustfmt::skip]
impl PartialEq<&str> for QuestionIdentifier {
...
#[rustfmt::skip]
impl std::fmt::Display for ProposalIdentifier {
    fn fmt(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        self.payload().fmt(formatter)
    }
}
#[rustfmt::skip]
impl AsRef<str> for ProposalIdentifier {
    fn as_ref(&self) -> &str {
        self.payload().as_str()
    }
}
#[rustfmt::skip]
impl PartialEq<&str> for ProposalIdentifier {
    fn eq(&self, other: &&str) -> bool {
        self.payload() == other
    }
}
...
#[rustfmt::skip]
impl PartialEq<&str> for SubscriptionToken {
    fn eq(&self, other: &&str) -> bool {
        self.payload() == other
    }
}
...
#[rustfmt::skip]
impl PartialEq<&str> for SubscriberName {
    fn eq(&self, other: &&str) -> bool {
        self.payload() == other
    }
}
...
#[rustfmt::skip]
impl AsRef<str> for AnswerText {
    fn as_ref(&self) -> &str {
        self.payload().as_str()
    }
}
#[rustfmt::skip]
impl PartialEq<&str> for AnswerText {
    fn eq(&self, other: &&str) -> bool {
        self.payload() == other
    }
}
...
#[rustfmt::skip]
impl std::fmt::Display for ExplanationText {
    fn fmt(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        self.payload().fmt(formatter)
    }
}
#[rustfmt::skip]
impl AsRef<str> for ExplanationText {
    fn as_ref(&self) -> &str {
        self.payload().as_str()
    }
}
#[rustfmt::skip]
impl PartialEq<&str> for ExplanationText {
    fn eq(&self, other: &&str) -> bool {
        self.payload() == other
    }
}
...
#[rustfmt::skip]
impl PartialEq<&str> for ContextLabel {
    fn eq(&self, other: &&str) -> bool {
        self.payload() == other
    }
}
...
#[rustfmt::skip]
impl std::fmt::Display for ContextBody {
    fn fmt(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        self.payload().fmt(formatter)
    }
}
#[rustfmt::skip]
impl AsRef<str> for ContextBody {
    fn as_ref(&self) -> &str {
        self.payload().as_str()
    }
}
#[rustfmt::skip]
impl PartialEq<&str> for ContextBody {
    fn eq(&self, other: &&str) -> bool {
        self.payload() == other
    }
}
...
#[rustfmt::skip]
impl std::fmt::Display for UpdateIdentifier {
    fn fmt(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        self.payload().fmt(formatter)
    }
}
#[rustfmt::skip]
impl AsRef<str> for UpdateIdentifier {
    fn as_ref(&self) -> &str {
        self.payload().as_str()
    }
}
#[rustfmt::skip]
impl PartialEq<&str> for UpdateIdentifier {
    fn eq(&self, other: &&str) -> bool {
        self.payload() == other
    }
}
...
#[rustfmt::skip]
impl AsRef<str> for ComponentLabel {
    fn as_ref(&self) -> &str {
        self.payload().as_str()
    }
}
#[rustfmt::skip]
impl PartialEq<&str> for ComponentLabel {
    fn eq(&self, other: &&str) -> bool {
        self.payload() == other
    }
}
...
#[rustfmt::skip]
impl std::fmt::Display for PaneLabel {
    fn fmt(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        self.payload().fmt(formatter)
    }
}
#[rustfmt::skip]
impl AsRef<str> for PaneLabel {
    fn as_ref(&self) -> &str {
        self.payload().as_str()
    }
}
#[rustfmt::skip]
impl PartialEq<&str> for PaneLabel {
    fn eq(&self, other: &&str) -> bool {
        self.payload() == other
    }
}
...
#[rustfmt::skip]
impl std::fmt::Display for NotificationText {
    fn fmt(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        self.payload().fmt(formatter)
    }
}
#[rustfmt::skip]
impl AsRef<str> for NotificationText {
    fn as_ref(&self) -> &str {
        self.payload().as_str()
    }
}
#[rustfmt::skip]
impl PartialEq<&str> for NotificationText {
    fn eq(&self, other: &&str) -> bool {
        self.payload() == other
    }
}
...
#[rustfmt::skip]
impl std::fmt::Display for RevisionCounter {
    fn fmt(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        self.payload().fmt(formatter)
    }
}
#[rustfmt::skip]
impl PartialEq<u64> for RevisionCounter {
    fn eq(&self, other: &u64) -> bool {
        self.payload() == other
    }
}
#[rustfmt::skip]
impl PartialOrd<u64> for RevisionCounter {
    fn partial_cmp(&self, other: &u64) -> Option<std::cmp::Ordering> {
        self.payload().partial_cmp(other)
    }
}
...
#[rustfmt::skip]
impl std::fmt::Display for ProposalDigest {
    fn fmt(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        self.payload().fmt(formatter)
    }
}
#[rustfmt::skip]
impl AsRef<str> for ProposalDigest {
    fn as_ref(&self) -> &str {
        self.payload().as_str()
    }
}
#[rustfmt::skip]
impl PartialEq<&str> for ProposalDigest {
    fn eq(&self, other: &&str) -> bool {
        self.payload() == other
    }
}
